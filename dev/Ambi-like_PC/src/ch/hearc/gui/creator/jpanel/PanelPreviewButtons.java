...
/**
 * Panel containing the preview of currently edited mode and the buttons to save
 * it or load a new one. <br>
...
public class PanelPreviewButtons extends JPanel {
     ...
     * Constructor
     *
     * @param colorChooser PanelColorChooser from which the color should be
     * taken.
     */
...
class PanelButtons extends JPanel {
     ...
     * Constructor
     *
     * @param parent The PanelPreviewButtons which contains this this
     * PanelButtons.
     */
